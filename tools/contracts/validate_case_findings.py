...
def main() -> int:
    if len(sys.argv) != 3:
        eprint("Usage: validate_case_findings.py <case_findings.schema.json> <case_findings.json>")
        return 2
    ...
    if errors:
        eprint("FAIL: case_findings schema validation failed")
    ...
    print("OK: case_findings validated")
    return 0
